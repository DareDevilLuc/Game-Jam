...
@onready var dialogue_res = preload("res://dialogue/player.dialogue")
@onready var interact = preload("res://dialogueBox/interact.tscn")
...
func _process(_delta):
	if player_in_range and not dialogue_open and Input.is_action_just_pressed("interact"):
		...
		balloon.start(dialogue_res, "VANITY")
...
func _on_trigger_body_entered(body):
	...
	vanity.modulate = Color(1.3, 1.3, 1.3)
